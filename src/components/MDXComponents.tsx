...
const MDXComponents = {
	...
	h2: (props: JSX.IntrinsicAttributes) => (
		<DocsHeading as="h2" size="3xl" {...props} />
	),
	h3: (props: JSX.IntrinsicAttributes) => (
		<DocsHeading as="h3" size="xl" {...props} />
	),
	h4: (props: JSX.IntrinsicAttributes) => (
		<DocsHeading as="h4" size="base" {...props} />
	),
	h5: (props: JSX.IntrinsicAttributes) => (
		<DocsHeading as="h5" size="sm" {...props} />
	),
	h6: (props: JSX.IntrinsicAttributes) => (
		<DocsHeading as="h6" size="sm" {...props} />
	),
	...
	p: (props: JSX.IntrinsicAttributes) => (
		<p className="mt-4 mb-2 leading-6" {...props} />
	),
	ul: (props: JSX.IntrinsicAttributes) => (
		<ul className="pt-2 pl-4 ml-2 max-w-full" {...props} />
	),
	ol: (props: JSX.IntrinsicAttributes) => (
		<ol className="pt-2 pl-4 ml-2 max-w-full" {...props} />
	),
	li: (props: JSX.IntrinsicAttributes) => (
		<li className="pb-1 max-w-full list-disc" {...props} />
	),
	blockquote: Quote,
}
